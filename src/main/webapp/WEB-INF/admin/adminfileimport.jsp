                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        <div id="customer_details" class="col2-set">
                            ...
                            <p id="image_path_field" class="form-row form-row-first validate-required">
                                <label for="excel">Excel File <abbr title="required"
                                                                                  class="required">*</abbr></label>
                                <input type="file" placeholder="required" id="excel" name="excel_file"
                                       class="input-text ">
                            </p>
                            <div class="clear"></div>
                            <div class="form-row place-order">
                                <input type="submit" data-value="Import" value="Import" id="submit" name="import"
                                       class="button alt">
                            </div>
                        </div>
                    </form>

...
<jsp:include page="WEB-INF/all/header.jsp"/>
                        ...
                        <div class="single-product">
                            <div class="product-f-image">
                                ...
                                <div class="product-hover">
                                    ...
                                    <a href="../assets/single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                </div>
                            </div>

                            <h2><a href="../assets/single-product.html">Samsung Galaxy s5- 2015</a></h2>
...
<jsp:include page="WEB-INF/all/footer.jsp"/>
</html>

...
CREATE TABLE `productvendor` (
  `productVendor_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`productVendor_id`),
  UNIQUE KEY `productVendor_productVendor_id_uindex` (`productVendor_id`),
  UNIQUE KEY `productVendor_name_uindex` (`name`)
...
INSERT INTO `productvendor` VALUES (3,'Acer'),(1,'Apple'),(4,'Asus'),(5,'Dell'),(6,'LG'),(7,'Nokia'),(2,'Samsung'),(8,'Sony');

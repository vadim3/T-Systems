...
CREATE TABLE `shippingmethod` (
  `shippingmethod_id` int(11) NOT NULL AUTO_INCREMENT,
  `status` varchar(45) NOT NULL,
  PRIMARY KEY (`shippingmethod_id`),
  UNIQUE KEY `shippingMethod_status_uindex` (`status`)
...
INSERT INTO `shippingmethod` VALUES (1,'Customer Pickup'),(2,'DHL delivery'),(3,'EMS delivery');

...
CREATE TABLE `accesslevel` (
  ...
  UNIQUE KEY `AccessLevel_accessLevel_id_uindex` (`accessLevel_id`),
  UNIQUE KEY `AccessLevel_status_uindex` (`status`)
...
INSERT INTO `accesslevel` VALUES (3,'Administrator'),(1,'userAvailable'),(2,'userBanned');

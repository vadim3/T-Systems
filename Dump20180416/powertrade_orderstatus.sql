...
CREATE TABLE `orderstatus` (
  ...
  UNIQUE KEY `orderstatus_orderStatus_id_uindex` (`orderStatus_id`),
  UNIQUE KEY `orderstatus_status_uindex` (`status`)
...
INSERT INTO `orderstatus` VALUES (3,'Acceptance'),(5,'Delivered'),(2,'Paid'),(4,'Shipped'),(1,'Waiting for payment');
